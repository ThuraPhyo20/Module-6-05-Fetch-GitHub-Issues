...
var getRepoName = function () {
  ...
  if (repoName) {
    ...
    // TODO: Write your answer here
    // When return to the homepage if there was nothing in the URL query parameter.
...
var displayIssues = function (issues) {
  ...
  // TODO: Write your answer here
  //check for strict equality. Using `!issues.length` works, but only because JavaScript considers `0` to be `falsy`.
  if (issues.length === 0) {
